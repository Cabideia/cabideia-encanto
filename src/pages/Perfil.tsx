 ...
 *
 * Lê e grava na tabela `perfis`. O @arroba é o slug da vitrine
 * (/encanto/@arroba): minúsculas, único, validado também no banco.
 */
  ...
  return (
    <div className="tela">
      ...
      <div className="cta-area">
        <button className="cta" onClick={salvar} disabled={salvando}>
